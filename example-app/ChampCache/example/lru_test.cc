...
void InitReplacementState()
{
    ...
    torch::Tensor tensor = torch::rand({10, 3});
...
{   
    ...
    std::cout << tensor << std::endl;
    // cout << std::hex << "PC " << PC << " paddr " << paddr << std::dec << " current_set " << current_set << " type " << type << endl;
...
{
    // cout << std::hex << "UpdateReplacementState PC " << PC << " paddr " << paddr << " victim_addr " << victim_addr << std::dec << " hit " << hit << ";" << endl;
